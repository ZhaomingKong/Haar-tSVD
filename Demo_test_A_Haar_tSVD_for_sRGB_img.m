...
for sigma = 20
    ...
    for i = 1:im_num
        ...
        % Use adaptive strategy (global)
        [sigma_est, maxK_est, tau_scaling] = global_noise_est(noisy_test, 8, SR, 32, 32);
        tau_est = tau * tau_scaling;
        

        tic
        [Denoised] = Haar_tSVD_with_mex(noisy_test, sigma, ps, maxK, SR, N_step, tau_est, divide_factor);
        time = toc;
